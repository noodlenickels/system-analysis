...
information_metrics = calculate_information_metrics()
print("Joint Entropy (H(AB)): {}".format(information_metrics[0]))
print("Entropy of A (H(A)): {}".format(information_metrics[1]))
print("Entropy of B (H(B)): {}".format(information_metrics[2]))
print("Conditional Entropy (H_A(B)): {}".format(information_metrics[3]))
print("Mutual Information (I(A,B)): {}".format(information_metrics[4]))